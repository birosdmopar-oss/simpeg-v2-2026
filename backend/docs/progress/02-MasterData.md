...
- G-TC #1–#6 lolos otomatis: `tests/MasterData/MasterGenericTcTest.php`, `RbacMasterEndpointsTest.php` (14 test).
- FE: `/master/:entity?` (menu "Master Data" hanya role 1), toggle switch + badge Aktif hijau/Non-aktif abu, naik/turun urutan, form tambah/edit, konfirmasi hapus (soft).
